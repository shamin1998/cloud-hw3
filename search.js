...
function voiceSearch(){
    ...
    micButton = document.getElementById("start-button");  
    console.log(micButton);
    console.log(micButton.innerHTML);
    if (micButton.innerHTML == "Recording (press again to stop)") {
    ...
    recognition.addEventListener("start", function() {
        micButton.innerHTML = "Recording (press again to stop)";
        console.log("Recording.....");
    });

    recognition.addEventListener("end", function() {
        console.log("Stopping recording.");
        micButton.innerHTML = "<i class='fa fa-microphone'></i> Speak";
    });
